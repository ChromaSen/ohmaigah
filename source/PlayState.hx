...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'classroom':
				...
				classroom=new FlxSprite().loadGraphic(Paths.image("classroom/room"));
				classroom.antialiasing=false;
				classroom.setPosition(60,105);
				add(classroom);
		...
		// startCountdown();
		dad.scale.set(1,1.1);
		boyfriend.scale.set(0.95,0.95);
		dad.setPosition(245,450);
		boyfriend.setPosition(716,381);
		trace("dad pos " + dad.getPosition());
		trace("boyfriend pos " + boyfriend.getPosition());
	...
	public function startCountdown():Void
	{
		...
		if(ret != FunkinLua.Function_Stop) {
			...
			if(curSong.toLowerCase()=='ohmygah'){
				trace('test');
	...
	override function destroy() {
		...
		Lib.application.window.title='ohmygah';
		super.destroy();
	}
	...
	override function stepHit()
	{
		...
		if(curSong.toLowerCase()=='ohmygah'){
			switch(curStep){
				case 56:
					snapCamFollowToPos(665,530);
					camGame.zoom=1.6;
					defaultCamZoom=1.6;
				case 60:
					snapCamFollowToPos(720,530);
					camGame.zoom=1.85;
					defaultCamZoom=1.85;
				case 64:
					snapCamFollowToPos(830,550);
					camGame.zoom=2.35;
					defaultCamZoom=2.35;
				case 73:
					snapCamFollowToPos(620,530);
					FlxG.camera.flash(FlxColor.WHITE,1);
					camGame.zoom=1.35;
					defaultCamZoom=1.35;
				case 102,136,166,200:Lib.application.window.title="POSE";
				case 104,168: Lib.application.window.title="POSE POSE";
				case 108,142,174,206: Lib.application.window.title="ohmygah";
